...
polygons = [
    ...
    [(915, 202), (1384, 486), (934, 661), (624, 255)],
    [(149, 509), (1166, 526), (1221, 1048), (9, 1048)],  # Camera 3
    [(404, 351), (934, 222), (1505, 514), (874, 1007)]
]
...
class CameraStream(threading.Thread):
    ...
    def run(self):
        ...
        while not self.stopped:
            ...
            for box, cls in zip(boxes, classes):
                if int(cls) == 0:  # Assuming class '0' is the object of interest(only person)
                    ...
                    if object_id is None:
                        ...
                        object_id_counter += 1
                        print(f'person count: {(object_id)}')                     #print.................
            ...
            # print(f'person count: {person_id}')
            # print(f'heatmap update')
        cap.release()
