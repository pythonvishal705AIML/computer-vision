...
ALL_FACES_DIR = Path("all_faces")
FACE_ENCODING_SIMILARITY_THRESHOLD = 0.6 
CROSSING_THRESHOLD = 2
MAX_FACE_DISTANCE = 150
FREQUENT_VISITOR_THRESHOLD = 3 
TRACKER_CONFIG = Path("bytetrack.yaml") 
...
class VisitorTracker:
    ...
    def update_visitor_status(self, track_id):
        ...
        if track_id not in self.visitor_data['visit_counts']:
            self.visitor_data['visit_counts'][track_id] = 1  
            self.visitor_data['visit_counts'][track_id] += 1  
